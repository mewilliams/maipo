...
save('../../edited_data/adcp/adcp_day1_cell1_U_and_time','U_fill10ma','timefill')
...
plot(adcp.mtime,U_10ma)

U_fill10ma(10288:15997) = NaN; % just throw out the messy part. 
plot(timefill,U_fill10ma)

save('../../edited_data/adcp/adcp_day2_cell1_U_and_time','U_fill10ma','timefill')
